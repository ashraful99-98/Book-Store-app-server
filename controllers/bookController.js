...
//         // const likes = Math.max(0, Math.min(10, faker.number.float({ mean: avgLikes, stddev: 0.5 })));
//         const likes = Math.max(0, Math.min(10, faker.number.float({ min: 0, max: 10 })) * (avgLikes / 10));
